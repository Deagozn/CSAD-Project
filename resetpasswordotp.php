...
<body class="bg-auto bg-repeat flex items-center justify-center h-screen" style="background-image: url('Resources/book-background.png')">
  ...
  <div class="max-w-md w-full mx-4 bg-white rounded-lg border border-black shadow-lg p-8">
    ...
    <form action="resetpasswordotp.php" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input class="form-control button w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 rounded mt-2" type="submit" name="check-reset-otp" value="Submit">
                    </div>
                </form>
        </div>
